      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">MAIN MENU</li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
            <i class="nav-icon fas fa-pencil-alt"></i>
            <p>Modul Survey <i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
                <?php
              $cek=$this->model_app->umenu_akses("instansi",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/instansi'><i class='far fa-circle nav-icon text-success'></i> <p>Data Instansi</p></a></li>";
              }
              
            //     $cek=$this->model_app->umenu_akses("aspek",$this->session->id_session);
            //   if($cek==1 OR $this->session->level=='admin'){
            //     echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/aspek'><i class='far fa-circle nav-icon text-success'></i> <p>Kategori Kuisioner</p></a></li>";
            //   }
              
               $cek=$this->model_app->umenu_akses("kuisioner",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/kuisioner'><i class='far fa-circle nav-icon text-success'></i> <p>Kuisioner</p></a></li>";
              }
              
               $cek=$this->model_app->umenu_akses("laporan",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/laporan'><i class='far fa-circle nav-icon text-success'></i> <p>Hasil Laporan</p></a></li>";
              }
              ;?>
            </ul>
          </li>
