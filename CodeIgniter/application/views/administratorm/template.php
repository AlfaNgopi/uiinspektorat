  ...
  <body class="sidebar-mini fixed skin-black-light">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px; background: #828282'>
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
          <a href="http://dinkominfo.purworejokab.go.id" style="margin-right:10px; text-decoration:none;">Selamat Datang Admin DISKOTIK</a>
