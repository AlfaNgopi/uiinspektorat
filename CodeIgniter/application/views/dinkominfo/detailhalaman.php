	...
	<div class="article-title">
		<div class="share-block right">
			<div>
				...
				<div class="left">
					...
					document.write("<a href='https://www.facebook.com/share.php?u=" + document.URL + " ' target='_blank' class='custom-soc icon-text'>&#62220;</a> <a href='https://twitter.com/home/?status=" + document.URL + "' target='_blank' class='custom-soc icon-text'>&#62217;</a> <a href='https://plus.google.com/share?url=" + document.URL + "' target='_blank' class='custom-soc icon-text'>&#62223;</a>");
					</script>
		...
		<div class="author">
			...
			<?php $test = md5(strtolower(trim($rows['email']))); 
				echo "<img src='https://www.gravatar.com/avatar/$test.jpg?s=100'/>";
			?>
			</span>
			<div class="a-content">
