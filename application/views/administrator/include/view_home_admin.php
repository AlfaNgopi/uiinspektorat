...
<div class="row">
    <div class="col-12 col-sm-6 col-md-3"><a href="https://inspektorat.purworejokab.go.id/ppid/admin/adminsuper_login.php">
      <div class="info-box">
          <img src="<?=base_url()?>asset/foto_banner_admin/logo_ppid.png" height="50px" width="250px">
        <div class="info-box-content">
    ...
    <div class="col-12 col-sm-6 col-md-3"><a href="https://aduanv2.purworejokab.go.id/cms/loginsso">
        <div class="info-box">
          <img src="<?=base_url()?>asset/foto_banner_admin/PORJO.png" height="60px" width="60px">
        <div class="info-box-content">
          <center><span class="info-box-text"><b>Login Admin Pengaduan PORJO</b></span></center></a>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
