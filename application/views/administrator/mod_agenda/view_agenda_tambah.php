          ...
          echo "
                  <table class='table table-sm table-borderless'>
                    <tbody>
                      ...
                      <tr><th scope='row'>Jam </th>                 <td><input type='time' class='form-control' name='e'></td></tr>
                      <tr><th scope='row'>Tgl <small>s/d</small> Selesai</th><td><input type='text' class='form-control' id='rangepicker' name='f' placeholder='00/00/0000 - 00/00/0000'></td></tr>
