    ...
    echo "
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Gambar</th>    <td><input type='file' class='form-control' name='c'><small><i>* max Upload <b style= 'color:red'>3MB</b>, Size <b style= 'color:red'>1180x344.17 px</b></i></small></td></tr>
                  </tbody>
                  </table>
