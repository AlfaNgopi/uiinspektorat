          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Posisi</th>    <td><select class='form-control' name='posisi' required>
                                                           ...
                                                           echo "</select></td></tr>
                    <tr><th scope='row'>Upload</th>    <td><input type='file' class='form-control' name='c'><small><i>* max Upload <b style= 'color:red'>3MB</b>, Size <b style= 'color:red'>728 x 90 px</b></i></small></td></tr>
                  </tbody>
                  </table>
