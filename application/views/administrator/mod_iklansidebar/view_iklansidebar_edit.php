    ...
    echo "
          ...
          echo "
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Gambar</th>    <td><input type='file' class='form-control' name='c'> <small><i>*Max Upload <b style='color:red'>3 MB</b>, Size <b style='color:red'> 200 x 200 px</b></i></small> &nbsp;";
