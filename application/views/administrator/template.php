...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <?php 
            if($this->uri->segment(2)!='home' AND $this->uri->segment(2)!=''){
              ...
              echo "<li class='breadcrumb-item'>Halo, Selamat Datang!</li>";
            }
          ?>
          </ol>
          </div><!-- /.col -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a target='_BLANK' href="https://inspektorat.purworejokab.go.id/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
