	...
	<div class="content-block main">
			<div class="block">
				<div class="block-title">
					<a href="<?php echo base_url(); ?>survey/responden" class="right">Back to data responden</a>
			...
			<?php if(date("m")<=06){
				...
				<div class="block-content">
			        <div class="paragraph-row">
			            <div class="column12"><center><h3>Kuisioner</h3></center></div>
				        <div class="column12">
					        <div style="width:370px" id="writecomment">
						        <form action="<?php echo base_url(); ?>survey/kuisioner" method="POST">
							        ...
							        <p class="contact-form-email">
								        ...
								        <input type="text" placeholder="E-mail Pribadi" name='b' id="c_email" required/>
							        </p>
